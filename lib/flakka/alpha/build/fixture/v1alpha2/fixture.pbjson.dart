...
const ModuleFixture$json = {
  ...
  '2': [
    {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.flakka.alpha.build.test.v1alpha1.AggregateFixture',
      '10': 'aggregate'
    },
  ],
};
...
final $typed_data.Uint8List moduleFixtureDescriptor = $convert.base64Decode(
    'Cg1Nb2R1bGVGaXh0dXJlEhIKBG5hbWUYASABKAlSBG5hbWUSUAoJYWdncmVnYXRlGAogAygLMj'
    'IuZmxha2thLmFscGhhLmJ1aWxkLnRlc3QudjFhbHBoYTEuQWdncmVnYXRlRml4dHVyZVIJYWdn'
    'cmVnYXRl');
...
const AggregateFixture$json = {
  ...
  '2': [
    ...
    {'1': 'package', '3': 2, '4': 1, '5': 9, '10': 'package'},
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.flakka.alpha.build.test.v1alpha1.EntityFixture',
      '10': 'entity'
    },
  ],
};
...
final $typed_data.Uint8List aggregateFixtureDescriptor = $convert.base64Decode(
    ...
    'IHcGFja2FnZRJHCgZlbnRpdHkYCiADKAsyLy5mbGFra2EuYWxwaGEuYnVpbGQudGVzdC52MWFs'
    'cGhhMS5FbnRpdHlGaXh0dXJlUgZlbnRpdHk=');
...
const EntityFixture$json = {
  ...
  '2': [
    {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.flakka.alpha.build.test.v1alpha1.MutationFixture',
      '10': 'mutation'
    },
    {
      '1': 'projection',
      ...
      '4': 1,
      '5': 11,
      '6': '.flakka.alpha.build.test.v1alpha1.ProjectionFixture',
      '10': 'projection'
    },
  ],
};
...
final $typed_data.Uint8List entityFixtureDescriptor = $convert.base64Decode(
    'Cg1FbnRpdHlGaXh0dXJlEhIKBG5hbWUYASABKAlSBG5hbWUSTQoIbXV0YXRpb24YAiABKAsyMS'
    '5mbGFra2EuYWxwaGEuYnVpbGQudGVzdC52MWFscGhhMS5NdXRhdGlvbkZpeHR1cmVSCG11dGF0'
    'aW9uElMKCnByb2plY3Rpb24YAyABKAsyMy5mbGFra2EuYWxwaGEuYnVpbGQudGVzdC52MWFscG'
    'hhMS5Qcm9qZWN0aW9uRml4dHVyZVIKcHJvamVjdGlvbg==');
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.flakka.alpha.build.test.v1alpha1.DispatchCommandFixture',
      '10': 'dispatchCommand'
    },
    {
      '1': 'state',
      ...
      '4': 1,
      '5': 11,
      '6': '.flakka.alpha.build.test.v1alpha1.StateFixture',
      '10': 'state'
    },
  ],
};
...
final $typed_data.Uint8List mutationFixtureDescriptor = $convert.base64Decode(
    'Cg9NdXRhdGlvbkZpeHR1cmUSYwoQZGlzcGF0Y2hfY29tbWFuZBgKIAMoCzI4LmZsYWtrYS5hbH'
    'BoYS5idWlsZC50ZXN0LnYxYWxwaGExLkRpc3BhdGNoQ29tbWFuZEZpeHR1cmVSD2Rpc3BhdGNo'
    'Q29tbWFuZBJECgVzdGF0ZRgCIAEoCzIuLmZsYWtrYS5hbHBoYS5idWlsZC50ZXN0LnYxYWxwaG'
    'ExLlN0YXRlRml4dHVyZVIFc3RhdGU=');
...
const DispatchCommandFixture$json = {
  ...
  '2': [
    {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.flakka.alpha.build.test.v1alpha1.CommandFixture',
      '10': 'command'
    },
    {
      '1': 'error',
      ...
      '4': 1,
      '5': 11,
      '6': '.flakka.alpha.build.test.v1alpha1.ErrorFixture',
      '10': 'error'
    },
  ],
};
...
final $typed_data.Uint8List dispatchCommandFixtureDescriptor = $convert.base64Decode(
    'ChZEaXNwYXRjaENvbW1hbmRGaXh0dXJlEhIKBG5hbWUYASABKAlSBG5hbWUSSgoHY29tbWFuZB'
    'gCIAEoCzIwLmZsYWtrYS5hbHBoYS5idWlsZC50ZXN0LnYxYWxwaGExLkNvbW1hbmRGaXh0dXJl'
    'Ugdjb21tYW5kEkQKBWVycm9yGAMgASgLMi4uZmxha2thLmFscGhhLmJ1aWxkLnRlc3QudjFhbH'
    'BoYTEuRXJyb3JGaXh0dXJlUgVlcnJvcg==');
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.flakka.alpha.build.test.v1alpha1.StateVariantFixture',
      '10': 'variant'
    },
  ],
};
...
final $typed_data.Uint8List stateFixtureDescriptor = $convert.base64Decode(
    'CgxTdGF0ZUZpeHR1cmUSTwoHdmFyaWFudBgBIAMoCzI1LmZsYWtrYS5hbHBoYS5idWlsZC50ZX'
    'N0LnYxYWxwaGExLlN0YXRlVmFyaWFudEZpeHR1cmVSB3ZhcmlhbnQ=');
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.flakka.alpha.build.test.v1alpha1.ViewQueryFixture',
      '10': 'viewQuery'
    },
    {
      '1': 'view_state',
      ...
      '4': 1,
      '5': 11,
      '6': '.flakka.alpha.build.test.v1alpha1.ViewStateFixture',
      '10': 'viewState'
    },
  ],
};
...
final $typed_data.Uint8List projectionFixtureDescriptor = $convert.base64Decode(
    'ChFQcm9qZWN0aW9uRml4dHVyZRJRCgp2aWV3X3F1ZXJ5GAEgAygLMjIuZmxha2thLmFscGhhLm'
    'J1aWxkLnRlc3QudjFhbHBoYTEuVmlld1F1ZXJ5Rml4dHVyZVIJdmlld1F1ZXJ5ElEKCnZpZXdf'
    'c3RhdGUYAiABKAsyMi5mbGFra2EuYWxwaGEuYnVpbGQudGVzdC52MWFscGhhMS5WaWV3U3RhdG'
    'VGaXh0dXJlUgl2aWV3U3RhdGU=');
...
const ViewQueryFixture$json = {
  ...
  '2': [
    {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.flakka.alpha.build.test.v1alpha1.QueryFixture',
      '10': 'query'
    },
    {
      '1': 'result',
      ...
      '4': 1,
      '5': 11,
      '6': '.flakka.alpha.build.test.v1alpha1.ViewResultFixture',
      '10': 'result'
    },
  ],
};
...
final $typed_data.Uint8List viewQueryFixtureDescriptor = $convert.base64Decode(
    'ChBWaWV3UXVlcnlGaXh0dXJlEhIKBG5hbWUYASABKAlSBG5hbWUSRAoFcXVlcnkYAiABKAsyLi'
    '5mbGFra2EuYWxwaGEuYnVpbGQudGVzdC52MWFscGhhMS5RdWVyeUZpeHR1cmVSBXF1ZXJ5EksK'
    'BnJlc3VsdBgDIAEoCzIzLmZsYWtrYS5hbHBoYS5idWlsZC50ZXN0LnYxYWxwaGExLlZpZXdSZX'
    'N1bHRGaXh0dXJlUgZyZXN1bHQ=');
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.flakka.alpha.build.test.v1alpha1.EventVariantFixture',
      '10': 'variant'
    },
  ],
};
...
final $typed_data.Uint8List eventFixtureDescriptor = $convert.base64Decode(
    'CgxFdmVudEZpeHR1cmUSTwoHdmFyaWFudBgBIAMoCzI1LmZsYWtrYS5hbHBoYS5idWlsZC50ZX'
    'N0LnYxYWxwaGExLkV2ZW50VmFyaWFudEZpeHR1cmVSB3ZhcmlhbnQ=');
