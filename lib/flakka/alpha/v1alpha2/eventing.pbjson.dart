  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.flakka.alpha.build.v1alpha2.EventSource',
      '10': 'in'
    },
    {
      '1': 'out',
      ...
      '4': 1,
      '5': 11,
      '6': '.flakka.alpha.build.v1alpha2.EventDestination',
      '10': 'out'
    },
  ],
};
...
final $typed_data.Uint8List eventingDescriptor = $convert.base64Decode(
    'CghFdmVudGluZxI4CgJpbhgBIAEoCzIoLmZsYWtrYS5hbHBoYS5idWlsZC52MWFscGhhMi5Fdm'
    'VudFNvdXJjZVICaW4SPwoDb3V0GAIgASgLMi0uZmxha2thLmFscGhhLmJ1aWxkLnYxYWxwaGEy'
    'LkV2ZW50RGVzdGluYXRpb25SA291dA==');
...
const EventSource$json = {
  ...
  '2': [
    ...
    {'1': 'value_entity', '3': 4, '4': 1, '5': 9, '9': 0, '10': 'valueEntity'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.flakka.alpha.build.v1alpha2.DirectSource',
      '9': 0,
      '10': 'direct'
    },
...
final $typed_data.Uint8List eventSourceDescriptor = $convert.base64Decode(
    ...
    'dmVudFNvdXJjZWRFbnRpdHkSIwoMdmFsdWVfZW50aXR5GAQgASgJSABSC3ZhbHVlRW50aXR5Ek'
    'MKBmRpcmVjdBgHIAEoCzIpLmZsYWtrYS5hbHBoYS5idWlsZC52MWFscGhhMi5EaXJlY3RTb3Vy'
    'Y2VIAFIGZGlyZWN0EhYKBmlnbm9yZRgFIAEoCFIGaWdub3JlEioKDmlnbm9yZV91bmtub3duGA'
    'YgASgISAFSDWlnbm9yZVVua25vd26IAQESKgoOaGFuZGxlX2RlbGV0ZXMYCCABKAhIAlINaGFu'
    'ZGxlRGVsZXRlc4gBAUIICgZzb3VyY2VCEQoPX2lnbm9yZV91bmtub3duQhEKD19oYW5kbGVfZG'
    'VsZXRlcw==');
...
const ServiceEventing$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.flakka.alpha.build.v1alpha2.ServiceEventingOut',
      '10': 'out'
    },
  ],
};
...
final $typed_data.Uint8List serviceEventingDescriptor = $convert.base64Decode(
    'Cg9TZXJ2aWNlRXZlbnRpbmcSOAoCaW4YASABKAsyKC5mbGFra2EuYWxwaGEuYnVpbGQudjFhbH'
    'BoYTIuRXZlbnRTb3VyY2VSAmluEkEKA291dBgCIAEoCzIvLmZsYWtrYS5hbHBoYS5idWlsZC52'
    'MWFscGhhMi5TZXJ2aWNlRXZlbnRpbmdPdXRSA291dA==');
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.flakka.alpha.build.v1alpha2.DirectDestination',
      '10': 'direct'
    },
  ],
};
...
final $typed_data.Uint8List serviceEventingOutDescriptor = $convert.base64Decode(
    'ChJTZXJ2aWNlRXZlbnRpbmdPdXQSRgoGZGlyZWN0GAEgASgLMi4uZmxha2thLmFscGhhLmJ1aW'
    'xkLnYxYWxwaGEyLkRpcmVjdERlc3RpbmF0aW9uUgZkaXJlY3Q=');
